...
class Helper
{
    ...
    public static function getGatewayShortName($className)
    {
        ...
        if (0 === strpos($className, 'Wenprise\\Alipay\\Omnipay\\')) {
     ...
     *      Stripe              => \Wenprise\Alipay\Omnipay\Stripe\Gateway
     *      PayPal\Express      => \Wenprise\Alipay\Omnipay\PayPal\ExpressGateway
     *      PayPal_Express      => \Wenprise\Alipay\Omnipay\PayPal\ExpressGateway
     *
    ...
    public static function getGatewayClassName($shortName)
    {
        ...
        if (0 === strpos($shortName, '\\') || 0 === strpos($shortName, 'Wenprise\\Alipay\\Omnipay\\')) {
            return $shortName;
        }
        ...
        return '\\Wenprise\\Alipay\\Omnipay\\'.$shortName.'Gateway';
    }
}
