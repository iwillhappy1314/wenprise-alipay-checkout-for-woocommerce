...
use Wenprise\Alipay\Http\Discovery\Exception\ClassInstantiationFailedException;
use Wenprise\Alipay\Http\Discovery\Exception\DiscoveryFailedException;
use Wenprise\Alipay\Http\Discovery\Exception\NoCandidateFoundException;
use Wenprise\Alipay\Http\Discovery\Exception\StrategyUnavailableException;
use Wenprise\Alipay\Http\Discovery\Strategy\DiscoveryStrategy;
