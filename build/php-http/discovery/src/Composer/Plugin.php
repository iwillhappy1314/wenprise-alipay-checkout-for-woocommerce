...
namespace Wenprise\Alipay\Http\Discovery\Composer;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = [
        'php-http/async-client-implementation' => [
            'Wenprise\Alipay\Http\Client\HttpAsyncClient',
        ],
        'php-http/client-implementation' => [
            'Wenprise\Alipay\Http\Client\HttpClient',
        ],
        'psr/http-client-implementation' => [
            'Wenprise\Alipay\Psr\Http\Client\ClientInterface',
        ],
        'psr/http-factory-implementation' => [
            'Wenprise\Alipay\Psr\Http\Message\RequestFactoryInterface',
            'Wenprise\Alipay\Psr\Http\Message\ResponseFactoryInterface',
            'Wenprise\Alipay\Psr\Http\Message\ServerRequestFactoryInterface',
            'Wenprise\Alipay\Psr\Http\Message\StreamFactoryInterface',
            'Wenprise\Alipay\Psr\Http\Message\UploadedFileFactoryInterface',
            'Wenprise\Alipay\Psr\Http\Message\UriFactoryInterface',
        ],
    ];
